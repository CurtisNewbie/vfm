...
Since v0.1.3, [fantahsea](https://github.com/curtisnewbie/fantahsea) has been merged into vfm codebase. Data must be migrated manually using SQLs or dump.
...
insert into vfm.gallery select * from fantahsea.gallery;
insert into vfm.gallery_image select * from fantahsea.gallery_image;
insert into vfm.gallery_user_access select * from fantahsea.gallery_user_access;
```